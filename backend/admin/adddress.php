...
mysqli_query($con,"insert into dress (dress_cat, dress_title, dress_desc, dress_image,dress_keywords) values ('$dress_type','$dress_name','$details','$pic_name','$tags')") or die ("query incorrect");
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="dress_name" required name="dress_name" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="number" id="dress_type" name="dress_type" required="[1-6]" class="form-control">
                      </div>
                    </div>
