...
?>
	...
	<th><a href="adduser.php" class="btn btn-success">Add New</a></th>
                    ...
                    <tbody>
                      <?php 
                        $result=mysqli_query($conn,"select user_id, username, user_email from users")or die ("query 2 incorrect.......");

                        while(list($user_id,$username,$user_email)=
                        mysqli_fetch_array($result))
                        {
                        echo "<tr><td>$username</td><td>$user_email</td>";
